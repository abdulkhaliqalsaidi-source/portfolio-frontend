<template>
  <a
    ...
    :aria-label="locale === 'en' ? 'Contact on WhatsApp' : 'تواصل عبر واتساب'"
  >
    ...
    <span class="wa-tooltip">{{ locale === 'en' ? 'Chat on WhatsApp' : 'تواصل عبر واتساب' }}</span>
    <span class="wa-pulse" />
  </a>
</template>
...
const whatsappNumber = computed(() => {
  return store.developer.whatsapp || store.settings.whatsapp_number || '967771523243'
})
</script>
