...
.avatar-wrap:hover .avatar-frame {
  ...
  box-shadow: 0 35px 65px -15px rgba(0, 0, 0, 0.8), 0 0 35px rgba(59, 130, 246, 0.35);
}
...
.float-card:hover {
  ...
  box-shadow: 0 25px 50px -10px rgba(0, 0, 0, 0.75), 0 0 25px var(--badge-color, rgba(59, 130, 246, 0.4));
